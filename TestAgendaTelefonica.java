...
public class TestAgendaTelefonica
{
    ...
    {   
        ...
        numeroTestsFallados += testea(null, agenda.lookupNumber("Pepe"), "lookupNumber()");
        agenda.enterNumber("Pepe","676464646");
        numeroTestsFallados += testea("676464646", agenda.lookupNumber("Pepe"), "lookupNumber()");
        numeroTestsFallados += testea(null, agenda.lookupNumber("Tomas"), "lookupNumber()");
